...
My Home Controller is an IOT (Internet Of Things) Project that allow you to controller
          ...
          ( LAN : Local Area Network) or via Your Smart Phone using the Node-RED 
          Mobile Application or with the a Network IP Adress . this Project Has 
          Benefits Mesure Temperature , Humidity and Gas after thzt store the 
